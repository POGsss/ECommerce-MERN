...
const Receipt = ({ token }) => {
	...
	return (
		<div className="flex flex-col items-start w-[calc(100%-16px)] sm:w-full">
			...
			<div className="w-full flex flex-col-reverse sm:flex-row items-start gap-4">
				...
				<div className="w-full flex flex-col sm:min-w-[250px] sm:max-w-[300px]">
					<div className="p-4 mb-4 bg-light-light rounded-[10px]">
						<Calculator amount={amount} />
					</div>
					<div className="p-4 bg-light-light rounded-[10px]">
