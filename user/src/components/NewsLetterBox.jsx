...
const NewsLetterBox = () => {
    ...
    return (
        <div className="text-center p-10 bg-primary rounded-[20px]">
            ...
            <form onSubmit={onSubmitHandler} className="w-full md:w-[700px] flex items-center gap-2 mx-auto my-6 rounded-[10px] overflow-hidden bg-light-light pl-4">
                <input className="w-full sm:flex-1 bg-transparent outline-none placeholder-gray-500" type="email" placeholder="Email..."/>
                <button className="font-text md:text-base px-8 py-4 bg-secondary text-white cursor-pointer" type="submit">SUBSCRIBE</button>
            </form>
        </div>
    )
}
