...
const OurPolicy = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center my-10 py-20 full-bleed bg-light-dark">
            <div className="w-full xl:w-[1000px] flex flex-col sm:flex-row justify-between gap-4 sm:gap-4 text-center text-xs sm:text-sm md:text-base text-black">
                <div className="bg-light-light p-8 rounded-[10px] hover:shadow-lg">
