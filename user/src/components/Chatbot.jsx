...
const Chatbot = () => {
  ...
  return (
    <div>
      {/* Floating Button */}
      <button onClick={toggleChat} id="floatingButton" className="flex flex-row items-center gap-4 fixed overflow-hidden w-[56px] transition-all bottom-5 right-5 z-9 bg-primary rounded-[10px] p-4 shadow-lg">
      ...
      {/* Chatbox */}
      {isOpen && (
        <div className="fixed flex flex-col z-50 bottom-[20px] right-[20px] w-[calc(100%-40px)] min-h-[450px] overflow-hidden max-h-[550px] bg-light-dark rounded-[10px] xs:w-[350px] shadow-lg">
          {/* Header */}
