	...
	return (
		<div className="sidebar w-[75px] md:w-[250px] border-r border-black">
			<div className="flex flex-col gap-4 py-6 text-base">
				<NavLink className="flex items-center gap-3 border border-black border-r-0 px-4 py-2" to="/analytics">
				...
				<NavLink className="flex items-center gap-3 border border-black border-r-0 px-4 py-2" to="/promotion">
					<img className="w-6 h-6" src={assets.promo_icon} alt="" />
					<p className="hidden md:block">Promotion</p>
				</NavLink>
			</div>
		</div>
	)
